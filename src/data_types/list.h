// Thanks to:
//  https://github.com/szhou42/osdev/blob/master/src/include/list.h
//  https://github.com/szhou42/osdev/blob/master/src/kernel/data_structure/list.c
...
listnode_t * list_get_node_by_index(list_t * list, int index) {
    if(index < 0 || (int64_t) index >= list_size(list))
        return NULL;
    int curr = 0;
    foreach(listnode, list) {
